...
public class DataInitializationRunner implements CommandLineRunner {
    ...
    private static class TempProduitData {
        ...
        public TempProduitData(Integer categorieId, Integer id, String nom, String description, Integer prix,
                String marque, String thumbnail, String couleur, String taille, Integer miniatureImageIndex) {
    ...
    public void run(String... args) throws Exception {
        ...
        if (produitRepository.count() == 0) {
            ...
            Map<Integer, String[]> categoryDetails = Map.of(
                    1, new String[] { "T-shirts Homme", "cat_1_thumb.jpg", "Collection de t-shirts pour hommes" },
                    2, new String[] { "T-shirts Femme", "cat_2_thumb.jpg", "Collection de t-shirts pour femmes" },
                    3, new String[] { "T-shirts Enfants", "cat_3_thumb.jpg", "Collection de t-shirts pour enfants" },
                    4, new String[] { "T-shirts Unisexe", "cat_4_thumb.jpg", "Collection de t-shirts unisexes" });

            // --- FULL LIST OF 10 PRODUCTS ---
            List<TempProduitData> initialProduitData = Arrays.asList(
                    new TempProduitData(2, 1, "T-shirt Unisexe", "T-shirt confortable et polyvalent pour tous.", 20,
                            "Nike", "https://nobero.com/cdn/shop/files/og.jpg?v=1722234051", "Blanc", "L", 0),
                    new TempProduitData(1, 2, "T-shirt Noir", "Un t-shirt en coton doux", 25, "Adidas",
                            "https://i.etsystatic.com/42116567/r/il/4cecee/5125476409/il_570xN.5125476409_g83c.jpg",
                            "Noir", "M", 0),
                    new TempProduitData(4, 3, "T-shirt Rouge", "Un t-shirt en polyester léger", 22, "Puma",
                            "https://assets.hermes.com/is/image/hermesproduct/t-shirt-broderie-h--072025HA01-worn-4-0-0-800-800_g.jpg",
                            "Rouge", "s", 0),
                    new TempProduitData(2, 4, "T-shirt rob", "T-shirt parfait pour le sport", 22, "Reebok",
                            "https://trans-shirt.fr/cdn/shop/products/SS031_Burgundy_FT_600x600.jpg", "Rouge", "s", 0),
                    new TempProduitData(2, 5, "T-shirt Vert",
                            "T-shirt écologique fabriqué à partir de matériaux recyclés", 30, "Patagonia",
                            "https://ker-crea.fr/5804-large_default/tee-shirt-homme-noir-personnalisable.jpg", "vert",
                            "L", 0),
                    new TempProduitData(3, 6, "T-shirt Gris", "Un t-shirt polyvalent au design minimaliste", 19,
                            "Under Armour",
                            "https://sport-clique.fr/2773-tm_large_default/t-shirt-sport-gris-clair.jpg", "Gris", "M",
                            0),
                    new TempProduitData(3, 7, "T-shirt jaune", "T-shirt vibrant pour un style estival", 21, "H&M",
                            "https://cdn3.brentinyparis.com/146898-zoom_image/t-shirt-large-jaune-uni.jpg", "Jaune",
                            "L", 0),
                    new TempProduitData(1, 8, "T-shirt Violet", "Un t-shirt doux et léger pour un confort optimal", 23,
                            "Uniqlo", "https://m.media-amazon.com/images/I/61gn3DFLlWL._AC_UY1000_.jpg", "Violet", "S",
                            0),
                    new TempProduitData(2, 9, "T-shirt Orange", "Idéal pour les amateurs de couleurs éclatantes", 24,
                            "Zara", "https://remote.max.maxhat.com/images/files/11941-31039-adpart.jpg", "Orange", "XL",
                            0),
                    new TempProduitData(4, 10, "T-shirt Rose", "Un t-shirt tendance et moderne", 20, "Levi's",
